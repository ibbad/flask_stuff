...
from .. import db
from ..models import User, Permission, Post, Permission
...
def show_all():
    ...
    resp.set_cookie('show_followed', '', max_age=30*24*60*60)       #age:30days
    return reps
...
def edit_profile():
    ...
    # set initial value for the first time when page is shown.
